...
class NEURAL_NETWORK: 
    ...
    def Get_Neuron_Joint(self,neuron):
        return self.neurons[neuron].Get_Joint_Name()
...
# ---------------- Private methods --------------------------------------
    ...
    def Get_Sensor_Neuron(self):
        return [neuron for neuron in self.neurons if self.neurons[neuron].Is_Sensor_Neuron()]
    ...
    def Get_Hidden_Neuron(self):
        return [neuron for neuron in self.neurons if self.neurons[neuron].Is_Hidden_Neuron()]
    ...
    def Get_Motor_Neuron(self):
        return [neuron for neuron in self.neurons if self.neurons[neuron].Is_Motor_Neuron()]
